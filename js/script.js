document.getElementById('switch').addEventListener('change', function() {
    ...
    if (this.checked) {
        ...
        document.getElementById('parrainage').innerHTML = '<a href="referral.html" class="text-white bg-blue-500 hover:bg-blue-400 px-4 py-2 rounded-md font-medium transition-all">Refer & Earn $200</a>';
        ...
        document.getElementById('parrainage').innerHTML = '<a href="parrainage.html" class="text-white bg-blue-500 hover:bg-blue-400 px-4 py-2 rounded-md font-medium transition-all">Parrainez & Gagnez 200$</a>';
