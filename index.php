...
<section id="temoignages-en" class="bg-gray-900 py-6 hidden">
  <div class="max-w-6xl mx-auto px-6">
    <h2 class="text-4xl font-extrabold text-white text-center mb-12">What Our Clients Say</h2>
    
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
      
      <!-- Testimonial 1 -->
      <div class="bg-gray-800 bg-opacity-80 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 border border-gray-700">
        <div class="flex items-center gap-4 mb-5">
          <img src="https://i.pravatar.cc/80?img=1" alt="User 1" class="w-16 h-16 rounded-full border-4 border-blue-500 shadow-md">
          <div>
            <h3 class="text-xl font-semibold text-white">John Doe</h3>
            <p class="text-sm text-gray-400">Business Owner</p>
            <div class="flex text-yellow-400 mt-2 animate-fadeIn">
              ★★★★★
            </div>
          </div>
        </div>
        <p class="text-gray-300 italic leading-relaxed">"QuickFix Brothers did an outstanding job. Their attention to detail and professionalism were top-notch. Highly recommended!"</p>
      </div>

      <!-- Testimonial 2 -->
      <div class="bg-gray-800 bg-opacity-80 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 border border-gray-700">
        <div class="flex items-center gap-4 mb-5">
          <img src="https://i.pravatar.cc/80?img=5" alt="User 2" class="w-16 h-16 rounded-full border-4 border-blue-500 shadow-md">
          <div>
            <h3 class="text-xl font-semibold text-white">Jane Smith</h3>
        ...
        <p class="text-gray-300 italic leading-relaxed">"Amazing service! The team was efficient, friendly, and went above and beyond. I'll definitely call them again!"</p>
      </div>

      <!-- Testimonial 3 -->
      <div class="bg-gray-800 bg-opacity-80 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 border border-gray-700">
        <div class="flex items-center gap-4 mb-5">
          <img src="https://i.pravatar.cc/80?img=8" alt="User 3" class="w-16 h-16 rounded-full border-4 border-blue-500 shadow-md">
          <div>
            <h3 class="text-xl font-semibold text-white">Mike Johnson</h3>
        ...
        <p class="text-gray-300 italic leading-relaxed">"They arrived on time, worked fast, and the result was flawless. Worth every penny!"</p>
      </div>
...
<section id="temoignages-fr" class="bg-gray-900 py-6">
  <div class="max-w-6xl mx-auto px-6">
    <h2 class="text-4xl font-extrabold text-white text-center mb-12">Ce que disent nos clients</h2>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
      ...
      <div class="bg-gray-800 bg-opacity-80 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 border border-gray-700">
        <div class="flex items-center gap-4 mb-5">
          <img src="https://i.pravatar.cc/80?img=1" alt="Utilisateur 1" class="w-16 h-16 rounded-full border-4 border-blue-500 shadow-md">
          <div>
            <h3 class="text-xl font-semibold text-white">Jean Dupont</h3>
            <p class="text-sm text-gray-400">Chef d’entreprise</p>
            <div class="flex text-yellow-400 mt-2 animate-fadeIn">
              ★★★★★
            </div>
          </div>
        </div>
        <p class="text-gray-300 italic leading-relaxed">"QuickFix Brothers a fait un travail exceptionnel. Leur souci du détail et leur professionnalisme sont irréprochables. Je recommande vivement !"</p>
      </div>

      <!-- Témoignage 2 -->
      <div class="bg-gray-800 bg-opacity-80 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 border border-gray-700">
        <div class="flex items-center gap-4 mb-5">
          <img src="https://i.pravatar.cc/80?img=5" alt="Utilisateur 2" class="w-16 h-16 rounded-full border-4 border-blue-500 shadow-md">
          <div>
            <h3 class="text-xl font-semibold text-white">Sophie Martin</h3>
            <p class="text-sm text-gray-400">Propriétaire</p>
            <div class="flex text-yellow-400 mt-2 animate-fadeIn">
              ★★★★☆
            </div>
          </div>
        </div>
        <p class="text-gray-300 italic leading-relaxed">"Service incroyable ! L’équipe a été rapide, efficace et très professionnelle. Je referai appel à eux sans hésiter !"</p>
      </div>

      <!-- Témoignage 3 -->
      <div class="bg-gray-800 bg-opacity-80 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition duration-300 border border-gray-700">
        <div class="flex items-center gap-4 mb-5">
          <img src="https://i.pravatar.cc/80?img=8" alt="Utilisateur 3" class="w-16 h-16 rounded-full border-4 border-blue-500 shadow-md">
          <div>
            <h3 class="text-xl font-semibold text-white">Michel Lefevre</h3>
            <p class="text-sm text-gray-400">Passionné de technologie</p>
            <div class="flex text-yellow-400 mt-2 animate-fadeIn">
              ★★★★★
            </div>
          </div>
        </div>
        <p class="text-gray-300 italic leading-relaxed">"Ils sont arrivés à l’heure, ont travaillé rapidement et le résultat était parfait. Chaque centime en valait la peine !"</p>
      </div>
